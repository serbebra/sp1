...
pub fn main() {
    ...
    type Diffusion = DiffusionMatrixBabybear;
    ...
    let poseidon2 = Poseidon2::<F, Diffusion, WIDTH, D>::new(
        rounds_f,
        rounds_p,
        RC_16_30().to_vec(),
        internal_mds,
...
/// Round constants taken from https://github.com/succinctlabs/vm/blob/838f16e0c4cd0cd3a0d4500430bc33b396805034/core/src/utils/poseidon2_instance.rs
/// The file is getting merged into the main repo, but I copied and pasted it here so I can use it
/// in the meantime.
fn RC_16_30() -> [[BabyBear; 16]; 30] {
    [
        [
...
// The output of the code above using https://github.com/succinctlabs/plonky3/commit/56e37ba41669e3729423a2f220d60d8dfbb31655
// input [
//     0,
//     1,
//     2,
...
//     567,
// ]
// output of the first round/input of the second round [
//     149075433,
//     626576475,
//     183548641,
//     825227416,
...
//     662288189,
// ]
// output of the second round/input of the third round [
//     296071203,
//     1886621810,
//     478678048,
//     304252337,
