...
pub struct EdAddAssignCols<T> {
    ...
    // For addition
    pub(crate) x2_sub_x1: FpOpCols<T>, // sub
    pub(crate) y2_sub_y1: FpOpCols<T>, // sub
    // pub(crate) lambda: FpDivCols<T>,    // TODO, implement FpDivCols
    pub(crate) lambda_sq: FpOpCols<T>,  // mul
    pub(crate) x1_plus_x2: FpOpCols<T>, // add
    pub(crate) x3: FpOpCols<T>,
    pub(crate) x1_sub_x3: FpOpCols<T>,            // sub
    pub(crate) lambda_mul_x1_sub_x3: FpOpCols<T>, // mul
    pub(crate) y3: FpOpCols<T>,                   // sub of lambda_mul_x1_sub_x3- y1

    // For double
    pub(crate) x1_sq: FpOpCols<T>,
    pub(crate) three_x1_sq: FpOpCols<T>,
    pub(crate) three_x1_sq_plus_a: FpOpCols<T>,
    pub(crate) two_y1: FpOpCols<T>,
    pub(crate) lambda: FpOpCols<T>,
}
